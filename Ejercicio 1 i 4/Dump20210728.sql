CREATE DATABASE  IF NOT EXISTS `actividades` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `actividades`;
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
-- Host: 192.168.1.45    Database: actividades
-- ------------------------------------------------------
...
INSERT INTO `articulos` VALUES (1,'Hard drive',197,5),(2,'Memory',10,6),(3,'ZIP drive',13,4),(4,'Floppy disk',1,6),(5,'Monitor',20,1),(6,'DVD drive',14,2),(7,'CD drive',7,2),(8,'Impresora Laser',22,3),(9,'Toner cartridge',5,3),(10,'DVD burner',14,2),(11,'Altavoces',63,2);
...
INSERT INTO `peliculas` VALUES (1,'Citizen Kane','PG'),(2,'Singin\' in the Rain','G'),(3,'The Wizard of Oz','G'),(4,'The Quiet Man','No recomendables para -13'),(5,'North by Northwest','No recomendables para -13'),(6,'The Last Tango in Paris','NC-17'),(7,'Some Like it Hot','PG-13'),(8,'A Night at the Opera','No recomendables para -13'),(9,'Citizen King','G'),(10,'Uno, Dos, Tres','Mayores 7');
...
INSERT INTO `salas` VALUES (1,'Odeon',5),(2,'Imperial',1),(3,'Majestic',NULL),(4,'Royale',6),(6,'Nickelodeon',NULL);
...
-- Dump completed on 2021-07-28 13:02:30
